window.onload = function () {
    ...
    frmAdmUtilizador.addEventListener("submit", function (event) {
        ...
        if (Utilizador.getIdByEmail(inputAdmUtilizadorEmail.value) === -1) {
            ...
            utilizadores.push(new Utilizador(inputAdmUtilizadorNome.value, inputAdmUtilizadorEmail.value,
                inputAdmUtilizadorPassword.value, inputAdmUtilizadorFoto.value, tipoAcesso))

            swal("Utilizador adicionado!", `O utilizador com o id ${Utilizador.getUltimoId()} dado pelo nome de ${inputAdmUtilizadorNome.value} foi editado com sucesso.`, "success");
            atualizarPercentagens()
            gerarTabelaUtilizadores()
            frmAdmUtilizador.reset()
        } else { //caso haja um utilizador com o mesmo email
            alert("ERRO: Já existe um utilizador registado com o mesmo email.")
        }
                            ...
                            modalBody.innerHTML = `<div class="container-fluid">
                                                        ...
                                                        <form class="form-horizontal" id="formAdmEditarUtilizador">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input id="inputAdmUtilizadorEditarNumeroRequisicoes" type="number" class="form-control" required readonly value="${Requisicao.quantidadeRequisicoesByIdUtilizador(utilizadores[j].id)}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label" for="inputAdmUtilizadorEditarLivrosRequisitados">Livros requisitados</label>
                                                                <div class="col-sm-9">
                                                                    <input id="inputAdmUtilizadorEditarLivrosRequisitados" type="text" class="form-control" required readonly value="${Requisicao.livrosRequisitadosByIdUtilizador(utilizadores[j].id).join(" / ")}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
